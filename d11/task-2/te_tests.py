...
def get_first_agent_id() -> Optional[int]:
    ...
    try:
        ...
        logger.error("Error decoding JSON response from agents endpoint.")
...
def find_existing_test_id(test_name: str) -> Optional[int]:
    ...
    try:
        ...
        logger.error("Error decoding JSON response from tests endpoint.")
...
def create_test(
    ...
    try:
        ...
        logger.error("Error decoding JSON response after test creation attempt.")
...
def get_test_results(test_id: int) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        logger.error("Error decoding JSON response from test results endpoint.")
